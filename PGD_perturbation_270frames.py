"""
Generates PGD attack perturbed frames for FF++ manipulated videos.
...
def test_full_image_network(video_path, model_path, output_path, cuda=True):
    ...
    while reader.isOpened():
        ...
        if len(faces):
            ...
            perturbed_image = PGD_attack(cropped_face, model, iters=5, cuda=cuda)
            # ------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    all_output_path = [
        '/mnt/xjc/Images_full/PGD5_perturbed/Deepfakes/c23',
        '/mnt/xjc/Images_full/PGD5_perturbed/Face2Face/c23',
        '/mnt/xjc/Images_full/PGD5_perturbed/FaceSwap/c23',
        '/mnt/xjc/Images_full/PGD5_perturbed/NeuralTextures/c23'
    ]

    model_path = '/mnt/xjc/Deepfake-Detection/best_epoch20.pkl'

    video_path = all_video_path[0]
    output_path = all_output_path[0]
    ...
    if video_path.endswith('.mp4') or video_path.endswith('.avi'):
        ...
        for video in videos:
            ...
            print('Finished processing %d / %d Deepfakes videos.'%(cnt, total))
